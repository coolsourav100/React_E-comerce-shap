...
const Header = (props) => {
  ...
  <a className="navbar-brand text-white d-flex justyfy-conternt-space-between">
    ...
    <button className="btn btn-outline-success w-10 me-4 my-2 my-sm-0 justify-content-end" type="submit" onClick={props.onShow}><i className="bi bi-cart"></i><CartIcon/><span className="badge badge-light">9</span></button>
